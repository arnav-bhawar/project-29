...
function mouseDragged(){
  //if (gameState!=="launched"){
      Matter.Body.setPosition(sprite.body, {x: mouseX , y: mouseY});
  //}
}
...
function keyPressed(){
  if(keyCode === 32 && sprite.body.speed<1){
     slingshot.attach(sprite.body);
     sprite.trajectory=[];
     Matter.Body.setPosition(sprite.body, {x: 200 , y: 50});
